...
| [Course 02](./course-02-building-the-portal.md) | Building the Portal in Go | All Go modules: config, fs, session, tailscale, HTTP server (text stubs) |
...
| [Course 05](./course-05-deployment.md) | Deployment | launchd service, Tailscale HTTPS, production checklist |
...
- Tailscale installed and connected to a tailnet (optional — needed for Course 05 Tailscale section only)

...
**Next:** [Course 05 — Deployment](./course-05-deployment.md) — install the portal as a `launchd` service that starts on login, configure Tailscale serve for HTTPS access, and set up the full production environment.

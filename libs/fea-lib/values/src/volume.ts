...
import { type Length, toM } from "./length";

// ---------------------------------------------------------------------------
// Volume unit constructors (internal, used by overloads)
// ---------------------------------------------------------------------------

const _μl = measure("μl", " μl", 0);
const _ml = measure("ml", " ml", 0);
const _cl = measure("cl", " cl", 0);
const _dl = measure("dl", " dl", 0);
const _l = measure("l", " l", 0);
const _cm3 = measure("cm3", " cm³", 0);
const _m3 = measure("m3", " m³", 0);
const _in3 = measure("in3", " in³", 0);
const _ft3 = measure("ft3", " ft³", 0);
const _floz = measure("floz", " fl oz", 0);
const _pint = measure("pint", " pint", 0);
const _qt = measure("qt", " qt", 0);
const _gal = measure("gal", " gal", 0);
...
function toM3(value: Volume): CubicMeters {
  switch (value.unit) {
    case "μl":
      return _m3(value.value * 0.000_000_001);
    case "ml":
      return _m3(value.value * 0.000_001);
    case "cl":
      return _m3(value.value * 0.000_01);
    case "dl":
      return _m3(value.value * 0.000_1);
    case "l":
      return _m3(value.value * 0.001);
    case "cm3":
      return _m3(value.value * 0.000_001);
    case "in3":
      return _m3(value.value * 0.000_016_387_064);
    case "ft3":
      return _m3(value.value * 0.028_316_846_592);
    case "floz":
      return _m3(value.value * 0.000_029_573_529_6);
    case "pint":
      return _m3(value.value * 0.000_473_176_473);
    case "qt":
      return _m3(value.value * 0.000_946_352_946);
    case "gal":
      return _m3(value.value * 0.003_785_411_784);
    default:
...
export function mul(a: Volume, factor: number): Volume {
  return _volumeAsImpl(
    { value: a.value * factor, unit: a.unit } as never,
    a.unit,
  );
}
...
export function div(a: Volume, divisor: number): Volume {
  ...
  return _volumeAsImpl(
    { value: a.value / divisor, unit: a.unit } as never,
    a.unit,
  );
}
